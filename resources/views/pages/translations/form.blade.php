<div class="form-group">
    <div class="input-group">
        <div class="input-group-addon">Translation of</div>
        ...
        @if ($errors->has('book_id'))
            <span class="error">
                <strong class="color-danger">{{ $errors->first('book_id') }}</strong>
            </span>
        @endif
    </div>
</div>
...
<div class="form-group">
	{!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => "Publication's title translated*"]) !!}
    @if ($errors->has('name'))
        <span class="error">
...
<div class="form-group">
    {!! Form::text('translated_by', null, ['class' => 'form-control', 'placeholder' => 'translated by (if not greek)']) !!}
...
<div class="form-group text-center">
	<a href="{{url('admin/translations')}}" class="btn btn-success">Back to Translations</a>
...
<script>
    ...
    $('.languages').select2({'placeholder': 'Select a language'});
