                ...
                <div class="row m-b-40">
                    ...
                    <div class="col-md-8">
                        @if($element->media()->where('type', '!=', 'cover')->exists())
                            <div class="col-sm-4">
                                @foreach($element->media as $img)
                                    <a data-lightbox="image" title="{{$img->description}}" href="{{asset('storage/app/public/the-trilogy-in-other-media/full/'.$img->filename)}}">
                                        <img class="img-responsive" alt="{{$img->description}}" src="{{asset('storage/app/public/the-trilogy-in-other-media/display/'.$img->filename)}}">
                                    </a>
                                @endforeach
                            </div>
                            <div class="col-sm-8">
