<div class="form-group">
	{!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => "Media's title*"]) !!}
    @if ($errors->has('name'))
        <span class="error">
...
<div class="form-group">
    {!! Form::text('link_text', null, ['class' => 'form-control', 'placeholder' => 'text you want to appear on the link ... i.e. See in this page']) !!}
</div>
...
<div class="form-group text-center">
	<a href="{{url('admin/trilogy-media')}}" class="btn btn-success">Back to Trilogy Media</a>
