...
<div class="form-group">
    {!! Form::select('language_id', $languages, null, ['placeholder' => 'language*', 'class' => 'form-control']) !!}
...
<div class="form-group">
    <div class="input-group">
        ...
        <select name="type" class="type form-control form-control-danger" >
            <option>OBBLIGATORY</option>
            @foreach($types as $id => $name)
                @if( in_array($id, $selectedType) )
...
<div class="form-group">
    {!! Form::text('location', null, ['class' => 'form-control', 'placeholder' => 'City, COUNTRY']) !!}
</div>
...
<div class="form-group text-center">
	<a href="{{url('admin/publications')}}" class="btn btn-success">Back to Publications</a>
