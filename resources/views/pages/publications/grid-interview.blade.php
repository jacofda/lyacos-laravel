<div class="col-md-10 col-md-offset-1 prodotti">
                    ...
                    <div class="portfolio-description text-left">
                        ...
                        @if(! is_null($publication->link_url) && strlen($publication->description) < 88 )
                            <a target="_BLANK" rel="nofollow" href="{{$publication->link_url}}">
                                <h3>{{$publication->interview_title}} <br>
                                    <small>
                        ...
                        @else
                            <a href="{{$publication->uri}}">
                                <h3>{{$publication->interview_title}} 
                                    <br>
                                    <small>
                                        {{$publication->h2}}
                                        @if($publication->location)
                        ...
                        @endif
                        <p class="smallerLineHeigh">{{strip_tags($publication->description)}}</p>
